...
const students: string[] = ['Bala', 'Senthil', 'Ramkilli', 'Kalai', 'karthick']

const isStudent: string = 'karthick';

console.time('runningTime');

const isStudentCheck = (students: string[], isStudent: string) => {
...
function arrayChunk(arr: Array<number>, size: number) {
    const result = [];
